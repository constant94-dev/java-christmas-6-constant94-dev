...
import static christmas.constant.view.ExceptionMessage.INVALID_TO_VALUE;
...
public final class MessageHandler {
    ...
    public static void invalidToValue() {
        throw new IllegalArgumentException(INVALID_TO_VALUE.getMessage());
    }
